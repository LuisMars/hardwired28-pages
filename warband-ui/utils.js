...
// Mode styling (Zorn palette) - labels use translations
const getModeStyles = () => ({
  build: { bg: 'bg-[#c9a227]', text: 'text-black', label: t('build') },
  edit: { bg: 'bg-[#8b2500]', text: 'text-white', label: t('edit') },
  play: { bg: 'bg-[#1a1a1a]', text: 'text-white', label: t('play') },
});
